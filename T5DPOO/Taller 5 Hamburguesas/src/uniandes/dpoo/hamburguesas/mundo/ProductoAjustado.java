...
public class ProductoAjustado implements Producto
{
    ...
    /***
     * Añade ingrediente adicional al pedido
     * @param Ingrediente El ingrediente que se va a eliminar al productoBase
     */
    public void agregarIngrediente(Ingrediente ingr) {
    	agregados.add(ingr);
    }
     ...
     * @return
     */
    public ArrayList<Ingrediente> ingredientesAgregados(){
    	return agregados;
    }
    
    /***
     * Añade ingrediente que debe ser eliminado
     * @param Ingrediente El ingrediente que se va a eliminar al productoBase
     */
    ...
    /***
     * Retorna la lista de ingredientes eliminados
     * @return
     */
    public ArrayList<Ingrediente> ingredientesEliminados(){
    	return eliminados;
    }
    ...
    public String generarTextoFactura( )
    {
        ...
        for( Ingrediente ing : ingredientesEliminados() )
        {
            sb.append( "    -" + ing.getNombre( ) );
        }
