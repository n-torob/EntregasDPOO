    ...
    public void paint( Graphics g )
    {
     ...
     // TODO completar y hacer que se vean los nombres de todos los restaurantes en el mapa
        ...
        for (int i =0 ; i < restaurantes.size();i++) {
        	g2d.fillOval(restaurantes.get(i).getX()-8, restaurantes.get(i).getY()-9, 7,7);
        	g2d.drawString(restaurantes.get(i).getNombre(), restaurantes.get(i).getX(), restaurantes.get(i).getY());
        }
